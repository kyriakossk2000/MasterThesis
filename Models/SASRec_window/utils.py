...
def data_partition_window(fname, window_size=7):
    usernum = 0
    itemnum = 0
    User = defaultdict(list)
    user_train = {}
...
def evaluate(model, dataset, args, N=5):
    ...
    for u in users:
        ...
        for _ in range(100):   # get negative samples
        ...
        rank = predictions.argsort().argsort()[:N]
